...
class SlidingWindowRateLimiter {
   ...
   * @return {number}
   */
  _limiter (key, mode, limit, ts, callback) {
    return this.redis.limiter(key, mode, this.interval, limit, ts, callback)
  }
  ...
  cancel (key, limit, ts, callback) {
    return this._limiter(key, MODE_CANCEL, limit, ts, callback)
  }
